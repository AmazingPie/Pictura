...
# 		self.label = tk.Label(self, text="Controls!")
# 		self.label.pack()

# 		self.img_dir = "..\\tests\\"
# 		self.img = Image.open(self.img_dir + "cat-low.jpg")
# 		#self.img.crop((100, 200, 300, 400))
# 		#(w, h) = self.img.size
# 		# self.img.crop(( 0, 0, w, h))
# 		# self.img.resize((w, h), Image.LANCZOS)
# 		#img = self.zoom_at(img=(self.img), x=200, y=200, zoom=0.5)
...
# 		self.canvas.create_image(0, 0, image=self.img_tk)
